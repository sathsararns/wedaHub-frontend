...
function Footer() {
  ...
  return (
    <footer className="w-full bg-[#0D1B3E] text-white px-4 py-12 md:px-8 lg:px-16 xl:px-24">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* Logo and Tagline */}
          <motion.div variants={columnVariants} className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <div className="flex items-center mb-4">
              <img src={logo} alt="wedahub Logo" className="h-14 sm:h-16 w-auto" />
            </div>
            ...
            >
              {socialLinks.map(({ label, path, fillRule, clipRule }) => (
                <motion.a
                  key={label}
                  href="#"
        ...
        <motion.div
          className="mt-12 pt-8 border-t border-white text-center text-gray-400 text-sm"
          initial={{ opacity: 0 }}
